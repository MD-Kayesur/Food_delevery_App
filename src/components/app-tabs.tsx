// Custom application tabs configuration with customized PNG icons
  ...
  return (
    <NativeTabs
      ...
      <NativeTabs.Trigger name="work">
        ...
        <NativeTabs.Trigger.Icon
          src={require('@/assets/images/tabIcons/work.png')}
          renderingMode="template"
        />
      </NativeTabs.Trigger>
      ...
      <NativeTabs.Trigger name="database">
        ...
        <NativeTabs.Trigger.Icon
          src={require('@/assets/images/tabIcons/database.png')}
          renderingMode="template"
        />
      </NativeTabs.Trigger>
    </NativeTabs>
